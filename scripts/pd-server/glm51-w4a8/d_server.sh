...
MODEL_PATH=/model2/llm-models/GLM-5.1-W4A8-V2_6; PORT=9352; VLLM_HOST_IP=""; GPU_RANGE=0,1,2,3,4,5,6,7; TP=8
...
for var in MODEL_PATH PORT VLLM_HOST_IP GPU_RANGE TP; do
...
cmd=(vllm serve "$MODEL_PATH" --kv-transfer-config '{"kv_connector":"MooncakeConnector","kv_role":"kv_consumer"}'
