...
def main():
    ...
    field_groups = [
        ...
        ("max_model_len", ["pd.service_defaults.max_model_len"]),
        ("gpu_memory_utilization", ["pd.service_defaults.gpu_memory_utilization"]),
        ("failure_model_max_sequence_length", ["failure.diagnostics.model_max_sequence_length"]),
        ("failure_required_kv_cache_gib", ["failure.diagnostics.required_kv_cache_gib"]),
        ("failure_available_kv_cache_gib", ["failure.diagnostics.available_kv_cache_gib"]),
        ("failure_estimated_max_model_len", ["failure.diagnostics.estimated_max_model_len"]),
